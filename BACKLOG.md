...
- [x] **37. Photos dans la fiche spectacle** — ✅ FAIT (b131). Section « 📷 Photos / plan de feu » : matche le nom du spectacle avec un sous-dossier du dossier Drive `1eGBxIRyvaRRkPEiVHvxCF21gwiGjAl6m`, charge les images en vignettes (clic = ouvre dans Drive). Pas de Firebase Storage — 100 % Drive. ⚠️ Le compte Google connecté doit avoir accès au dossier ; les sous-dossiers doivent être nommés comme les spectacles.
